...
function Header() {
	...
	const hiddedArticles = useSelector((state) => state.hiddenArticles.value);
	...
	const handleRegister = () => {
		fetch('https://morningnews-backend1.vercel.app/users/signup', {
			method: 'POST',
	...
	const handleConnection = () => {
		...
		fetch('https://morningnews-backend1.vercel.app/users/signin', {
			method: 'POST',
			headers: { 'Content-Type': 'application/json' },
	...
	return (
		<header className={styles.header}>
			...
			<FontAwesomeIcon onClick={() => showHiddedArticles()} className={styles.userSection} icon={faEye} />
